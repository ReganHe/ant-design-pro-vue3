 ...
 */
export const exchangeRefreshToken = base.createRequest<GwsToken.exchangeRefreshToken.Options, GwsToken.exchangeRefreshToken.Returns['data']>(s + 'exchangeRefreshToken', (data) => ({url: `/account/exchange_refresh_token`, method: 'POST', data }))
