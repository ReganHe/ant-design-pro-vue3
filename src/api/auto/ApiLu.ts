 ...
 */
export const initDayInspectData = base.createRequest<Lu.initDayInspectData.Options, Lu.initDayInspectData.Returns['data']>(s + 'initDayInspectData', (params) => ({url: `/1.0/lu/init_data`, method: 'GET', params }))
