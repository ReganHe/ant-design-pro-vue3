 ...
 */
export const getOne = base.createRequest<SafetyTraining.getOne.Options, SafetyTraining.getOne.Returns['data']>(s + 'getOne', ({ id, ...params}) => ({url: `/1.0/safety_training/get_one/${id}`, method: 'GET', params }))
 ...
 */
export const getPaged = base.createRequest<SafetyTraining.getPaged.Options, SafetyTraining.getPaged.Returns['data']>(s + 'getPaged', (params) => ({url: `/1.0/safety_training/get_paged`, method: 'GET', params }))
 ...
 */
export const remove = base.createRequest<SafetyTraining.remove.Options, SafetyTraining.remove.Returns['data']>(s + 'remove', ({ id, ...params}) => ({url: `/1.0/safety_training/remove/${id}`, method: 'DELETE', params }))
