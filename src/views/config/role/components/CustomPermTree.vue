<template>
  <div class="custom-perm-tree">
    <Tree :tree-data="treeModel.data" :checkedKeys="defaultCheckedKeys" :selectable="false"
      v-model:expandedKeys="treeModel.expandedKeys" :accordion="true" :checkable="true" @check="handleCheck" />
  </div>
</template>
