<template>
  <span>
    <!-- 技能 -->
    <a-form-item label="技能" :required="false">
      <TagsSelect :tags="allSkills" @change="onSelectTag" :defaultValue="userInfo.skills" type="skills" :size="size" />
      <AddNewTag @success="onAddSuccess" type="skills" :defaultAdded="userInfo.mySkills" :size="size" />
    </a-form-item>
